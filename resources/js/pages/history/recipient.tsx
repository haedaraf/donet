...
import { History, CheckCircle2, Package, User } from 'lucide-react';
        ...
        <DashboardLayout>
            ...
            <div className="p-8 max-w-5xl mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-[14px] text-gray-500">Daftar barang donasi yang telah sukses Anda terima dari donatur.</p>
                </div>
                ...
                {(!histories?.data || histories.data.length === 0) ? (
                    <div className="bg-white rounded-3xl p-12 border border-gray-200 text-center flex flex-col items-center justify-center">
                        ...
                        <p className="text-[14px] text-gray-500 mb-8 max-w-md">Anda belum memiliki riwayat penerimaan barang yang selesai.</p>
                    </div>
                ) : (
                        ...
                        {histories.data.map((history: any) => (
                            <div key={history.id} className="bg-white rounded-2xl border border-gray-200 overflow-hidden flex flex-col hover:border-gray-300 transition-colors shadow-sm">
                                ...
                                <div className="p-5 flex-1 flex flex-col">
                                    ...
                                    <span className="text-[12px] text-gray-500 mb-4">Diambil pada {formatDate(history.updated_at)}</span>
